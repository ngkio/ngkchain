...
#include <ngk/chain/action_receipt.hpp>
...
FC_REFLECT( ngk::chain::account_delta,
            (account)(delta) )

FC_REFLECT( ngk::chain::action_trace,
...
FC_REFLECT( ngk::chain::transaction_trace, (id)(block_num)(block_time)(producer_block_id)
