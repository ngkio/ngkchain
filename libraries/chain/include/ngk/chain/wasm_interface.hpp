...
namespace ngk { namespace chain {
      ...
      public:
         ...
         { try {
            ...
            if( whitelisted_intrinsics != nullptr ) {
               ...
               NGK_ASSERT( mod_name == "env", wasm_exception,
            ...
            NGK_THROW( wasm_exception, "${module}.${export} unresolveable",
                      ("module",mod_name)("export",export_name) );
            return false;
   ...
   class wasm_interface {
      public:
         ...
         wasm_interface(vm_type vm, bool ngkvmoc_tierup, const chainbase::database& d, const boost::filesystem::path data_dir, const ngkvmoc::config& ngkvmoc_config);
         ~wasm_interface();

         //call before dtor to skip what can be minutes of dtor overhead with some runtimes; can cause leaks
         void indicate_shutting_down();

         //validates code -- does a WASM validation pass and checks the wasm against NGK specific constraints
      ...
      private:
         ...
         friend class ngk::chain::webassembly::common::intrinsics_accessor;
   };
...
FC_REFLECT_ENUM( ngk::chain::wasm_interface::vm_type, (wabt)(ngk_vm)(ngk_vm_jit)(ngk_vm_oc) )
