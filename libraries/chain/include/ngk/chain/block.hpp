...
FC_REFLECT_ENUM( ngk::chain::transaction_receipt::status_enum,
                 (executed)(soft_fail)(hard_fail)(delayed)(expired) )

FC_REFLECT(ngk::chain::transaction_receipt_header, (status)(cpu_usage_us)(net_usage_words) )
FC_REFLECT_DERIVED(ngk::chain::transaction_receipt, (ngk::chain::transaction_receipt_header), (trx) )
FC_REFLECT(ngk::chain::additional_block_signatures_extension, (signatures));
FC_REFLECT_DERIVED(ngk::chain::signed_block, (ngk::chain::signed_block_header), (transactions)(block_extensions) )
