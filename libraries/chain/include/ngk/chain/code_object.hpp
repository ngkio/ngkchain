...
CHAINBASE_SET_INDEX_TYPE(ngk::chain::code_object, ngk::chain::code_index)

FC_REFLECT(ngk::chain::code_object, (code_hash)(code)(code_ref_count)(first_block_used)(vm_type)(vm_version))
