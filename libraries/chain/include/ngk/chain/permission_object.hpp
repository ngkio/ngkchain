...
CHAINBASE_SET_INDEX_TYPE(ngk::chain::permission_object, ngk::chain::permission_index)
CHAINBASE_SET_INDEX_TYPE(ngk::chain::permission_usage_object, ngk::chain::permission_usage_index)

FC_REFLECT(ngk::chain::permission_object, (usage_id)(parent)(owner)(name)(last_updated)(auth))
FC_REFLECT(ngk::chain::snapshot_permission_object, (parent)(owner)(name)(last_updated)(last_used)(auth))

FC_REFLECT(ngk::chain::permission_usage_object, (last_used))
