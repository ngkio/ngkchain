...
#include <ngk/chain/incremental_merkle.hpp>
...
CHAINBASE_SET_INDEX_TYPE(ngk::chain::global_property_object, ngk::chain::global_property_multi_index)
CHAINBASE_SET_INDEX_TYPE(ngk::chain::dynamic_global_property_object,
                         ngk::chain::dynamic_global_property_multi_index)

FC_REFLECT(ngk::chain::global_property_object,
            (proposed_schedule_block_num)(proposed_schedule)(configuration)(chain_id)
          )

FC_REFLECT(ngk::chain::legacy::snapshot_global_property_object_v2,
            (proposed_schedule_block_num)(proposed_schedule)(configuration)
          )

FC_REFLECT(ngk::chain::snapshot_global_property_object,
            (proposed_schedule_block_num)(proposed_schedule)(configuration)(chain_id)
          )

FC_REFLECT(ngk::chain::dynamic_global_property_object,
