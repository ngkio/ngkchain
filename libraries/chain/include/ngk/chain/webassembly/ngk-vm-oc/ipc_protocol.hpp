...
using ngkvmoc_message = fc::static_variant<initialize_message,
...
FC_REFLECT(ngk::chain::ngkvmoc::initialize_message, )
FC_REFLECT(ngk::chain::ngkvmoc::initalize_response_message, (error_message))
FC_REFLECT(ngk::chain::ngkvmoc::code_tuple, (code_id)(vm_version))
FC_REFLECT(ngk::chain::ngkvmoc::compile_wasm_message, (code))
FC_REFLECT(ngk::chain::ngkvmoc::evict_wasms_message, (codes))
FC_REFLECT(ngk::chain::ngkvmoc::code_compilation_result_message, (start)(apply_offset)(starting_memory_pages)(initdata_prologue_size))
FC_REFLECT(ngk::chain::ngkvmoc::compilation_result_unknownfailure, )
FC_REFLECT(ngk::chain::ngkvmoc::compilation_result_toofull, )
FC_REFLECT(ngk::chain::ngkvmoc::wasm_compilation_result_message, (code)(result)(cache_free_bytes))