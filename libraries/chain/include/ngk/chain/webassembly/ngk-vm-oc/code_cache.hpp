...
namespace std {
    template<> struct hash<ngk::chain::ngkvmoc::code_tuple> {
        size_t operator()(const ngk::chain::ngkvmoc::code_tuple& ct) const noexcept {
...
class code_cache_base {
   public:
      code_cache_base(const bfs::path data_dir, const ngkvmoc::config& ngkvmoc_config, const chainbase::database& db);
      ~code_cache_base();
...
class code_cache_async : public code_cache_base {
   public:
      code_cache_async(const bfs::path data_dir, const ngkvmoc::config& ngkvmoc_config, const chainbase::database& db);
      ~code_cache_async();
