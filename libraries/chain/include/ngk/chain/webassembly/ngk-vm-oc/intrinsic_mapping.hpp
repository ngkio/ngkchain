...
constexpr auto intrinsic_table = boost::hana::make_tuple(
   "ngkvmoc_internal.unreachable"_s,
   "ngkvmoc_internal.grow_memory"_s,
   "ngkvmoc_internal.div0_or_overflow"_s,
   "ngkvmoc_internal.indirect_call_mismatch"_s,
   "ngkvmoc_internal.indirect_call_oob"_s,
   "ngkvmoc_internal.depth_assert"_s,
   "ngk_injection.call_depth_assert"_s,  //these two are never used by NGK VM OC but all intrinsics
   "ngk_injection.checktime"_s,          //must be mapped
   "env.__ashlti3"_s,
   "env.__ashrti3"_s,
   "env.__lshlti3"_s,
   "env.__lshrti3"_s,
   ...
   "env.abort"_s,
   "env.ngk_assert"_s,
   "env.ngk_assert_message"_s,
   "env.ngk_assert_code"_s,
   "env.ngk_exit"_s,
   ...
   "env.memcmp"_s,
   "env.memset"_s,
   "ngk_injection._ngk_f32_add"_s,
   "ngk_injection._ngk_f32_sub"_s,
   "ngk_injection._ngk_f32_mul"_s,
   "ngk_injection._ngk_f32_div"_s,
   "ngk_injection._ngk_f32_min"_s,
   "ngk_injection._ngk_f32_max"_s,
   "ngk_injection._ngk_f32_copysign"_s,
   "ngk_injection._ngk_f32_abs"_s,
   "ngk_injection._ngk_f32_neg"_s,
   "ngk_injection._ngk_f32_sqrt"_s,
   "ngk_injection._ngk_f32_ceil"_s,
   "ngk_injection._ngk_f32_floor"_s,
   "ngk_injection._ngk_f32_trunc"_s,
   "ngk_injection._ngk_f32_nearest"_s,
   "ngk_injection._ngk_f32_eq"_s,
   "ngk_injection._ngk_f32_ne"_s,
   "ngk_injection._ngk_f32_lt"_s,
   "ngk_injection._ngk_f32_le"_s,
   "ngk_injection._ngk_f32_gt"_s,
   "ngk_injection._ngk_f32_ge"_s,
   "ngk_injection._ngk_f64_add"_s,
   "ngk_injection._ngk_f64_sub"_s,
   "ngk_injection._ngk_f64_mul"_s,
   "ngk_injection._ngk_f64_div"_s,
   "ngk_injection._ngk_f64_min"_s,
   "ngk_injection._ngk_f64_max"_s,
   "ngk_injection._ngk_f64_copysign"_s,
   "ngk_injection._ngk_f64_abs"_s,
   "ngk_injection._ngk_f64_neg"_s,
   "ngk_injection._ngk_f64_sqrt"_s,
   "ngk_injection._ngk_f64_ceil"_s,
   "ngk_injection._ngk_f64_floor"_s,
   "ngk_injection._ngk_f64_trunc"_s,
   "ngk_injection._ngk_f64_nearest"_s,
   "ngk_injection._ngk_f64_eq"_s,
   "ngk_injection._ngk_f64_ne"_s,
   "ngk_injection._ngk_f64_lt"_s,
   "ngk_injection._ngk_f64_le"_s,
   "ngk_injection._ngk_f64_gt"_s,
   "ngk_injection._ngk_f64_ge"_s,
   "ngk_injection._ngk_f32_promote"_s,
   "ngk_injection._ngk_f64_demote"_s,
   "ngk_injection._ngk_f32_trunc_i32s"_s,
   "ngk_injection._ngk_f64_trunc_i32s"_s,
   "ngk_injection._ngk_f32_trunc_i32u"_s,
   "ngk_injection._ngk_f64_trunc_i32u"_s,
   "ngk_injection._ngk_f32_trunc_i64s"_s,
   "ngk_injection._ngk_f64_trunc_i64s"_s,
   "ngk_injection._ngk_f32_trunc_i64u"_s,
   "ngk_injection._ngk_f64_trunc_i64u"_s,
   "ngk_injection._ngk_i32_to_f32"_s,
   "ngk_injection._ngk_i64_to_f32"_s,
   "ngk_injection._ngk_ui32_to_f32"_s,
   "ngk_injection._ngk_ui64_to_f32"_s,
   "ngk_injection._ngk_i32_to_f64"_s,
   "ngk_injection._ngk_i64_to_f64"_s,
   "ngk_injection._ngk_ui32_to_f64"_s,
   "ngk_injection._ngk_ui64_to_f64"_s
);
