...
FC_REFLECT(ngk::chain::permission_level_weight, (permission)(weight) )
FC_REFLECT(ngk::chain::key_weight, (key)(weight) )
FC_REFLECT(ngk::chain::wait_weight, (wait_sec)(weight) )
FC_REFLECT(ngk::chain::authority, (threshold)(keys)(accounts)(waits) )
FC_REFLECT(ngk::chain::shared_key_weight, (key)(weight) )
FC_REFLECT(ngk::chain::shared_authority, (threshold)(keys)(accounts)(waits) )
FC_REFLECT(ngk::chain::shared_public_key, (pubkey))