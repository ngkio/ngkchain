...
CHAINBASE_SET_INDEX_TYPE(ngk::chain::permission_link_object, ngk::chain::permission_link_index)

FC_REFLECT(ngk::chain::permission_link_object, (account)(code)(message_type)(required_permission))
