...
#include <ngk/chain/multi_index_includes.hpp>
...
CHAINBASE_SET_INDEX_TYPE(ngk::chain::table_id_object, ngk::chain::table_id_multi_index)
CHAINBASE_SET_INDEX_TYPE(ngk::chain::key_value_object, ngk::chain::key_value_index)

CHAINBASE_SET_INDEX_TYPE(ngk::chain::index64_object, ngk::chain::index64_index)
CHAINBASE_SET_INDEX_TYPE(ngk::chain::index128_object, ngk::chain::index128_index)
CHAINBASE_SET_INDEX_TYPE(ngk::chain::index256_object, ngk::chain::index256_index)
CHAINBASE_SET_INDEX_TYPE(ngk::chain::index_double_object, ngk::chain::index_double_index)
CHAINBASE_SET_INDEX_TYPE(ngk::chain::index_long_double_object, ngk::chain::index_long_double_index)

FC_REFLECT(ngk::chain::table_id_object, (code)(scope)(table)(payer)(count) )
FC_REFLECT(ngk::chain::key_value_object, (primary_key)(payer)(value) )

#define REFLECT_SECONDARY(type)\
  FC_REFLECT(type, (primary_key)(payer)(secondary_key) )

REFLECT_SECONDARY(ngk::chain::index64_object)
REFLECT_SECONDARY(ngk::chain::index128_object)
REFLECT_SECONDARY(ngk::chain::index256_object)
REFLECT_SECONDARY(ngk::chain::index_double_object)
REFLECT_SECONDARY(ngk::chain::index_long_double_object)
