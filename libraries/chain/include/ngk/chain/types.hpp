...
namespace ngk { namespace chain {
   ...
   /**
    *  Important notes on using chainbase objects in NGK code:
    *
    ...
    *  others are due to requirements to ensure determinism in the NGK chain library.
    *
...
FC_REFLECT_EMPTY( ngk::chain::void_t )
