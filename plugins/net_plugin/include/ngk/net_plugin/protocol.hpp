...
FC_REFLECT( ngk::select_ids<fc::sha256>, (mode)(pending)(ids) )
FC_REFLECT( ngk::chain_size_message,
            (last_irreversible_block_num)(last_irreversible_block_id)
            (head_num)(head_id))
FC_REFLECT( ngk::handshake_message,
            (network_version)(chain_id)(node_id)(key)
            (time)(token)(sig)(p2p_address)
            (last_irreversible_block_num)(last_irreversible_block_id)
            (head_num)(head_id)
            (os)(agent)(generation) )
FC_REFLECT( ngk::go_away_message, (reason)(node_id) )
FC_REFLECT( ngk::time_message, (org)(rec)(xmt)(dst) )
FC_REFLECT( ngk::notice_message, (known_trx)(known_blocks) )
FC_REFLECT( ngk::request_message, (req_trx)(req_blocks) )
FC_REFLECT( ngk::sync_request_message, (start_block)(end_block) )
