...
CHAINBASE_SET_INDEX_TYPE( ngk::public_key_history_object, ngk::public_key_history_multi_index )

FC_REFLECT( ngk::public_key_history_object, (public_key)(name)(permission) )
