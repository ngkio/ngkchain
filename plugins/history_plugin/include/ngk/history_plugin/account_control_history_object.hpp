...
CHAINBASE_SET_INDEX_TYPE( ngk::account_control_history_object, ngk::account_control_history_multi_index )

FC_REFLECT( ngk::account_control_history_object, (controlled_account)(controlled_permission)(controlling_account) )
