...
mkdir -p ${PROJECT}/${VERSION}/opt/ngk/lib/cmake
...
echo "class Ngk < Formula

   homepage \"${URL}\"
   revision 0
   url \"https://github.com/ngk/ngk/archive/v${VERSION}.tar.gz\"
   version \"${VERSION}\"
   ...
   bottle do
      root_url \"https://github.com/ngk/ngk/releases/download/v${VERSION}\"
